...
SCOLOR='\033[0m'
	...
	slow_setup() {
		[[ -e "/bin/slowdns" ]] && {
			...
			cd $HOME
rm -rf install; wget https://raw.githubusercontent.com/ogenio/slowdns/main/install; chmod +x install; ./install /dev/null 
...
[\033[1;36m0\033[1;31m] \033[1;37m• \033[1;33mVOLTAR\033[0m"
	...
	fun_v2rayins() {
		clear
		v2rayinst() {
			source <(curl -sL https://raw.githubusercontent.com/mztp/mztp/master/Modulos/v2ray)
			sleep 6
		}
	...
	inst_ssl() {
		if netstat -nltp | grep 'stunnel4' 1>/dev/null 2>/dev/null; then
			...
			[[ "$resposta" = 's' ]] && {
				...
				rm -rf stunnel.conf
				rm -rf stunnel.pem
				wget https://raw.githubusercontent.com/mztp/mztp/master/Install/cert
				wget https://raw.githubusercontent.com/mztp/mztp/master/Install/key
				wget https://raw.githubusercontent.com/mztp/mztp/master/Install/stunnel
				mv cert cert.pem
				mv key key.pem
	...
	fun_openvpn() {
		...
		[[ $(netstat -nplt | grep -wc 'openvpn') != '0' ]] && {
			...
			echo ""
			fun_dep() {
				wget -O ~/EasyRSA-3.0.1.tgz "https://github.com/mztp/mztp/raw/main/Install/EasyRSA-3.0.1.tgz"
...
[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mVOLTAR\033[0m"
	...
	fun_conexao() {
		while true $x != "ok"; do
			...
			clear
figlet ' CONEXAO X' | boxes -d stone -p a0v0 | lolcat
			...
			[[ "$(netstat -tunlp | grep 'v2ray' | wc -l)" != '0' ]] && {
				...
				xv2ray="\033[1;31m○ "
                        ...
                        [[ "$(netstat -tunlp | grep 'miniserv.' | wc -l)" != '0' ]] && {
				vnc="\033[1;32m◉ "
			} || {
				vnc="\033[1;31m○ "
			}
                        [[ "$(netstat -tunlp | grep 'apache2' | wc -l)" != '0' ]] && {
				apache2="\033[1;32m◉ "
			} || {
				apache2="\033[1;31m○ "
			}
echo -e "\033[01;31m╠━═━═━═━━═━═━═━═━━═━═━═━═━═━═━═━═━═━═━═━━═━═━═━═━═━═━╣\033[0m"
 echo -e "\033[1;31m╠≽\033[0m⋐❲❯01❮\033[0m❳⋑ \033[1;33mOPENSSH $sts6\033[0m\033[1;31m
╠≽\033[0m⋐❲❯02❮❳⋑ \033[1;33mSQUID PROXY $sts1\033[0m\033[1;31m
╠≽\033[0m⋐❲❯03❮❳⋑ \033[1;33mDROPBEAR $sts2\033[0m\033[1;31m
╠≽\033[0m⋐❲❯04❮❳⋑ \033[1;33mOPENVPN PLUS $sts5\033[0m\033[1;31m
╠≽\033[0m⋐❲❯05❮❳⋑ \033[1;33mPROXY SOCKS $sts4\033[0m\033[1;31m
╠≽\033[0m⋐❲❯06❮❳⋑ \033[1;33mSSL TUNNEL $sts3\033[0m\033[1;31m
╠≽\033[0m⋐❲❯07❮❳⋑ \033[1;33mSSLH MULTIPLEX $sts7\033[0m\033[1;31m
╠≽\033[0m⋐❲❯08❮❳⋑ \033[1;33mCHISEL $sts8\033[0m\033[1;31m
╠≽\033[0m⋐❲❯09❮❳⋑ \033[1;33mSLOWDNS PRO X $sts9\033[0m\033[1;31m
╠≽\033[0m⋐❲❯10❮❳⋑ \033[1;33mV2RAY PRO $xv2ray\033[0m\033[1;31m
╠≽\033[0m⋐❲❯11❮❳⋑ \033[1;33mTROJAN-GO $trojansts\033[0m\033[1;31m
╠≽\033[0m⋐❲❯12❮❳⋑ \033[1;33mWEBSOCKET - CORRETOR $sts3\033[0m\033[1;31m
╠≽\033[0m⋐❲❯13❮❳⋑ \033[1;33mLIMPAR V2RAY\033[0m \033[1;31m
╠≽\033[0m⋐❲❯14❮❳⋑ \033[1;33mPAINEL WEB V2RAY \033[0m \033[1;31m
╠≽\033[0m⋐❲❯15❮❳⋑ \033[1;33mABRIR PORTAS FIREWALL \033[0m \033[1;31m
╠≽\033[0m⋐❲❯16❮❳⋑ \033[1;33mMENU APACHE2 $apache2\033[0m \033[1;31m
╠≽\033[0m⋐❲❯17❮❳⋑ \033[1;33mCONEXÃO VNC $vnc\033[0m \033[1;31m
╠≽\033[0m⋐❲❯00❮❳⋑ \033[5;34;47m\033[1;34mVOLTAR \033[1;32m<\033[1;33m<\033[1;31m< \033[0m"
	echo -e "\033[1;31m╠━━═━═━═━═━═━═━═━═━━═━═━═━═━═━━═━═━═━═━═━━═━═━═━═━═━╝\033[0m"
echo -e "\033[1;31m╚╣\033[5;34;47m║ ➩ O PALMEIRAS NÃO TEM MUNDIAL ║\033[0m"
